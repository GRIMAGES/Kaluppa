...
function filterByCourse() {
    const courseId = document.getElementById('courseFilter').value; // Get the selected course ID
    ...
    if (courseId === "") {
        ...
        table.column(4).search(courseId, true, false).draw(); // Filter by course ID
    }
}
