...
$query = "
    ...
    UNION
    SELECT volunteer_application.id, volunteer_application.status, volunteer_application.applied_at, works.title AS course_name, volunteer_application.resume, 'Volunteer' AS type
                            ...
                            <tr data-type="<?php echo htmlspecialchars($application['type']); ?>">
                                ...
                                <td>
                                    ...
                                    <form method="POST" action="/Kaluppa/Backend/user_controller/delete_application.php" style="display:inline;">
                                        ...
                                        <input type="hidden" name="application_type" value="<?php echo htmlspecialchars($application['type']); ?>"> <!-- Pass application type -->
