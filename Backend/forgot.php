...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['forgot_password'])) {
    ...
    if ($emailFound) {
        ...
        try {
            ...
            $mail->Body    = 'Click the following link to reset your password: <a href="https://kaluppa.online/Kaluppa/Backend/changepassword.php?reset_token=' . $resetToken . '">Reset Password</a>';
